...
*
set more 1
global CSDIR="$root/Build/Temp"
global NAMDIR ="$root/Build/Code/std_name"
*use $CSDIR/compustat_a_list,clear
use $CSDIR/NETS_1990_2017,clear


  **   Clean names
  rename hqcompany name
*  rename coname name
*  rename file csfile
  gen file = "CS"
  gen asstype = "firm"
...
*  replace standard_name=" U.S. PHILIPS CORPORATION " if trim(standard_name)=="NORTH AMERICAN PHILIPS CORP"
  ...
  replace standard_name=" WESTINGHOUSE ELECTRIC CORP. " if trim(standard_name)=="WESTINGHOUSE ELEC"
  replace standard_name="21ST CENTURY ONCOLOGY INC" if trim(standard_name)=="21ST CNTURY ONCLOGY HLDNGS INC"
  replace standard_name="21ST CENTURY ONCOLOGY INC" if trim(standard_name)=="21ST CENTURY ONCOLOGY OF CALIF"
...
/* 3b */ 
  ...
  rename name hqcompany 
	rename stem_name hqcompany_st
	rename standard_name hqcompany_std
 save $CSDIR/NETS_1990_2017_std, replace
